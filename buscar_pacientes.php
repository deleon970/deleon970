...
$nombre_propietario = isset($_POST['nombre_propietario']) ? $_POST['nombre_propietario'] : null;
...
if (!empty($nombre_propietario)) {
    $sql .= " AND Nombre_propietario LIKE ?";
}
if (!empty($nombre)) {
    $sql .= " AND Nombre LIKE ?";
}
...
if ($resultado->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>ID_paciente</th><th>ID_cita</th><th>Nombre_propietario</th><th>Nombre</th><th>Especie</th><th>Sexo</th><th>Peso</th><th>Edad</th></tr>";
    while ($fila = $resultado->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . htmlspecialchars($fila['id_paciente']) . "</td>";
        echo "<td>" . htmlspecialchars($fila['id_cita']) . "</td>";
        echo "<td>" . htmlspecialchars($fila['Nombre_propietario']) . "</td>";
